...
console.log(tamanho_colecao);

var numero_sortudo = Math.floor(Math.random() * tamanho_colecao);
console.log(numero_sortudo);
// Math.floor Retorna um numero aleatorio entre 0 e <1
// Math.floor Arredonda um numero para baixo para o numero inteiro mais proximo

var curiosidade_escolhida = curiosidades_chuck_norris[numero_sortudo];
console.log(curiosidade_escolhida);
